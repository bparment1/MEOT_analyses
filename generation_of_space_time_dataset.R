...
library(vegan) 
library(zoo)        #time series functionalities extends xts
library(parallel)   # parallelization based on snow

##### Functions used in this script #####

functions_generation_space_time_datasets <- "generation_of_space_time_dataset_functions_10212013v5.R"

script_path<-"/Users/benoitparmentier/Dropbox/Data/MEOT_paper/synthetic_dataset_10162013" #path to script
...
out_dir<- "/Users/benoitparmentier/Dropbox/Data/MEOT_paper/synthetic_dataset_10162013"
